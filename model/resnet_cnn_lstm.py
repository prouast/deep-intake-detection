...
class Model(object):
    """Base class for ResNet CNN-LSTM model."""
    ...
    def __init__(self, params):
        ...
        self.num_lstm = params.resnet_num_lstm
    ...
    def __call__(self, inputs, is_training, scope=SCOPE):
        ...
        with tf.variable_scope(scope, custom_getter=self._custom_dtype_getter):
            ...
            # Reshape to feed all images through CNN
            ...
            inputs = tf.reshape(inputs,
                [-1, self.sequence_length, inputs.get_shape()[1]])
